...
impl PictureRepository {
        ...
        E: Executor<'e, Database = Postgres>,
    {
        sqlx::query_as!(
            Picture,
            r#"INSERT INTO pictures (local_user_id, s3_key_original, filename, exif_data, metadata)
    ...
    pub async fn list_by_user<'e, E>(ex: E, local_user_id: Uuid) -> Result<Vec<Picture>, AppError>
    where
        E: Executor<'e, Database = Postgres>,
    {
        sqlx::query_as!(
            ...
            r#"SELECT id, local_user_id, remote_picture_id, owner_username, owner_instance_domain,
                      ...
                      exif_data, metadata, deleted_at, captured_at, ingested_at, updated_at
               FROM pictures
               WHERE local_user_id = $1 AND deleted_at IS NULL
