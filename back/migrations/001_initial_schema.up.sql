...
(
    ...
    -- Original file; bucket determined by S3_BUCKET_ORIGINALS env var
    s3_key_original   VARCHAR(1024) NOT NULL,

    -- Thumbnail keys; NULL until generated by workers
    -- Buckets determined by S3_BUCKET_SMALL, S3_BUCKET_MEDIUM, S3_BUCKET_LARGE env vars
    s3_key_small      VARCHAR(1024),
    s3_key_medium     VARCHAR(1024),
    s3_key_large      VARCHAR(1024),
